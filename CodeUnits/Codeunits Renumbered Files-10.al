OBJECT CodeUnit 20374 Dates Calculation
{
  OBJECT-PROPERTIES
  {
    Date=11/06/20;
    Time=10:24:26 AM;
    Modified=Yes;
    Version List=Agile ManagementV1.0(Surestep Systems);
  }
  PROPERTIES
  {
    OnRun=VAR
            HRLeaveApplication@1120054000 : Record 51516191;
          BEGIN
            HRLeaveApplication.GET('LEAV00013');
  ...
  CODE
  {
    ...
    VAR
      AbsenceHoliday@1000000003 : Record 51516161;
    ...
    VAR
      StatutoryHoliday@1000000002 : Record 51516161;
