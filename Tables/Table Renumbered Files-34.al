OBJECT table 50053 Bank Acc. Statement Linevb
{
  OBJECT-PROPERTIES
  {
    Date=12/05/17;
    Time=11:27:02 AM;
    Modified=Yes;
    Version List=Bank Reconcilliation;
  }
  PROPERTIES
  {
    ...
    CaptionML=ENU=Bank Acc. Statement Line;
  }
  FIELDS
  {
    ...
    { 3   ;   ;Statement Line No.  ;Integer       ;AutoIncrement=Yes;
    ...
    { 14  ;   ;Check No.           ;Code80        ;CaptionML=ENU=Check No. }
    { 15  ;   ;Related-Party Name  ;Text50        ;CaptionML=ENU=Related-Party Name }
    { 16  ;   ;Additional Transaction Info;Text100;CaptionML=ENU=Additional Transaction Info }
    { 17  ;   ;Posting Exch. Entry No.;Integer    ;TableRelation="Data Exch.";
    ...
    { 24  ;   ;Related-Party Bank Acc. No.;Text50 ;CaptionML=ENU=Related-Party Bank Acc. No. }
    ...
    { 480 ;   ;Dimension Set ID    ;Integer       ;TableRelation="Dimension Set Entry";
                                                   ...
                                                   Editable=No }
    { 50000;  ;Reconciled          ;Boolean        }
    { 50004;  ;Open Type           ;Option        ;OptionCaptionML=ENU=" ,Unpresented Cheques List,Uncredited Cheques List";
                                                   OptionString=[ ,Unpresented,Uncredited] }
    { 50005;  ;Imported            ;Boolean       ;Description=Imported from bank statement, not suggested }
    { 50006;  ;Reconciling Date    ;Date           }
  }
  KEYS
  {
    {    ;Statement Line No.                      ;Clustered=Yes }
  }
  FIELDGROUPS
  {
  }
  CODE
  {
    ...
    PROCEDURE ClearPostExchEntries@5();
    VAR
    ...
    PROCEDURE RemoveApplication@1(AppliedType@1000 : Option);
    BEGIN
      {
    ...
    PROCEDURE GetCustomerLedgerEntriesInAmountRange@41(VAR CustLedgerEntry@1004 : Record 21;AccountNo@1005 : Code[20];AmountFilter@1001 : Text;MinAmount@1002 : Decimal;MaxAmount@1003 : Decimal) : Integer;
    VAR
    ...
    PROCEDURE GetVendorLedgerEntriesInAmountRange@42(VAR VendorLedgerEntry@1004 : Record 25;AccountNo@1005 : Code[20];AmountFilter@1002 : Text;MinAmount@1001 : Decimal;MaxAmount@1000 : Decimal) : Integer;
    VAR
