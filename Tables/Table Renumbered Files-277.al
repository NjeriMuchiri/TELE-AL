OBJECT table 20420 CRBA Datas2
{
  OBJECT-PROPERTIES
  {
    Date=04/03/20;
  ...
  FIELDS
  {
    ...
    { 30  ;   ;Original Amount     ;Decimal        }
    { 31  ;   ;Currency of Facility;Code10         }
    { 32  ;   ;Amonut in Kenya shillings;Decimal  ;AutoFormatType=0 }
    { 33  ;   ;Current Balance     ;Decimal        }
    ...
    { 44  ;   ;Date of Latest Payment;Date         }
    ...
    { 54  ;   ;Plot Number         ;Code30         }
    { 55  ;   ;PIN Number          ;Code30         }
    { 56  ;   ;Employment Date     ;Date           }
    { 57  ;   ;Salary Band         ;Decimal        }
    ...
    { 69  ;   ;Name 2              ;Text30         }
    { 70  ;   ;Name 3              ;Text30         }
    { 71  ;No ;Date A/C Opened     ;Date           }
    { 72  ;   ;Account Opened Date ;Date           }
    { 73  ;   ;[ Balance Outstanding];Decimal      }
    { 74  ;   ;Outstanding Balance ;Decimal        }
