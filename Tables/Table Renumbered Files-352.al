OBJECT table 20497 G/L Entry Archive
{
  OBJECT-PROPERTIES
  {
    Date=02/05/21;
  ...
  FIELDS
  {
    ...
    { 51  ;   ;Bal. Account Type   ;Option        ;CaptionML=[ENU=Bal. Account Type;
                                                   ...
                                                   OptionCaptionML=[ENU=G/L Account,Customer,Vendor,Bank Account,Fixed Asset,IC Partner,Employee;
                                                                    ESM=Cuenta,Cliente,Proveedor,Banco,Activo,Empresa vinculada asociada,Empleado;
                                                                    FRC=Compte du grand livre,Client,Fournisseur,Compte bancaire,Immobilisations,Partenaire IC,Employ ;
    ...
    { 55  ;   ;Document Date       ;Date          ;CaptionML=[ENU=Document Date;
                                                              ...
                                                              ENC=Document Date];
                                                   ClosingDates=Yes }
    { 56  ;   ;External Document No.;Code50       ;CaptionML=[ENU=External Document No.;
    ...
    { 57  ;   ;Source Type         ;Option        ;CaptionML=[ENU=Source Type;
                                                              ...
                                                              FRC=Type origine;
                                                              ENC=Source Type];
                                                   OptionCaptionML=[ENU=" ,Customer,Vendor,Bank Account,Fixed Asset,Employee,MEMber";
                                                                    ESM=" ,Cliente,Proveedor,Banco,Activo,Empleado";
                                                                    FRC=" ,Client,Fournisseur,Compte bancaire,Immobilisation,Employ ";
                                                                    ENC=" ,Customer,Vendor,Bank Account,Fixed Asset,Employee"];
                                                   OptionString=[ ,Customer,Vendor,Bank Account,Fixed Asset,Employee,Member] }
    ...
    { 71  ;   ;Close Income Statement Dim. ID;Integer;
                                                   CaptionML=[ENU=Close Income Statement Dim. ID;
                                                              ...
                                                              FRC=Code axe cl t. exerc. cmptble;
    ...
    { 51516000;;Payroll Period     ;Date           }
    { 51516001;;EXIST              ;Integer       ;FieldClass=FlowField;
                                                   CalcFormula=Count(Vendor WHERE (No.=FIELD(Source No.))) }
  }
  KEYS
  {
