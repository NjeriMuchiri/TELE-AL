OBJECT table 50034 Budgetary Control Setup
{
  OBJECT-PROPERTIES
  {
    Date=01/31/19;
  ...
  FIELDS
  {
    ...
    { 2   ;   ;Current Budget Code ;Code20        ;TableRelation="G/L Budget Name".Name }
    { 3   ;   ;Current Budget Start Date;Date      }
    { 4   ;   ;Current Budget End Date;Date        }
    ...
    { 8   ;   ;Budget Dimension 4 Code;Code20     ;TableRelation=Dimension;
                                                   OnValidate=BEGIN
                                                                {
    ...
    { 9   ;   ;Budget Dimension 5 Code;Code20     ;TableRelation=Dimension;
                                                   OnValidate=BEGIN
                                                                {
                                                                IF "Budget Dimension 4 Code" <> xRec."Budget Dimension 4 Code" THEN BEGIN
                                                                  IF Dim.CheckIfDimUsed("Budget Dimension 4 Code",12,Name,'',0) THEN
    ...
    { 10  ;   ;Budget Dimension 6 Code;Code20     ;TableRelation=Dimension;
                                                   OnValidate=BEGIN
                                                                {
                                                                IF "Budget Dimension 4 Code" <> xRec."Budget Dimension 4 Code" THEN BEGIN
                                                                  IF Dim.CheckIfDimUsed("Budget Dimension 4 Code",12,Name,'',0) THEN
    ...
    { 11  ;   ;Analysis View Code  ;Code20        ;TableRelation="Analysis View".Code }
    { 12  ;   ;Dimension 1 Code    ;Code20        ;TableRelation=Dimension;
                                                   OnValidate=BEGIN
                                                                {
    ...
    { 13  ;   ;Dimension 2 Code    ;Code20        ;TableRelation=Dimension;
                                                   OnValidate=BEGIN
                                                                {
                                                                TESTFIELD(Blocked,FALSE);
    ...
    { 14  ;   ;Dimension 3 Code    ;Code20        ;TableRelation=Dimension;
                                                   OnValidate=BEGIN
                                                                {
                                                                TESTFIELD(Blocked,FALSE);
    ...
    { 15  ;   ;Dimension 4 Code    ;Code20        ;TableRelation=Dimension;
                                                   OnValidate=BEGIN
                                                                {
                                                                TESTFIELD(Blocked,FALSE);
    ...
    { 17  ;   ;Allow OverExpenditure;Boolean       }
    { 18  ;   ;Current Item Budget ;Code10        ;TableRelation="Item Budget Name".Name }
    { 19  ;   ;Budget Check Criteria;Option       ;OptionCaptionML=ENU=Current Month,Whole Year;
                                                   OptionString=Current Month,Whole Year }
    { 20  ;   ;Actual Source       ;Option        ;OnValidate=BEGIN
    ...
    { 21  ;   ;Partial Budgetary Check;Boolean     }
  }
  KEYS
  {
