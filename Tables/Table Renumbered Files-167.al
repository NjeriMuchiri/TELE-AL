OBJECT table 17285 Checkoff Header-Distributed
{
  OBJECT-PROPERTIES
  {
    Date=04/25/17;
  ...
  PROPERTIES
  {
    ...
    LookupPageID=Page39004339;
    DrillDownPageID=Page39004339;
  }
  FIELDS
  {
    ...
    { 33  ;   ;Emp Not Fount       ;Integer       ;FieldClass=FlowField;
                                                   CalcFormula=Count("Checkoff Lines-Distributed" WHERE (Receipt Header No=FIELD(No),
                                                                                                         Staff Not Found=FILTER(Yes))) }
  }
  KEYS
  {
    {    ;No                                      ;Clustered=Yes }
