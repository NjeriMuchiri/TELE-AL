OBJECT page 172117 CRBA List
{
  ...
  PROPERTIES
  {
    ...
    OnAfterGetRecord=BEGIN
                       ...
                       IF STRLEN(workString)>2 THEN BEGIN
                         ...
                         IF (Surname='') AND (Forename2<>'') THEN BEGIN
                            Surname:=Forename2;
                            Forename2:='';
                         END;

                         IF (Forename3<>'') AND (Surname='') THEN BEGIN
                            Surname:=Forename3;
                            Forename3 := '';
                         END;

                        IF (Forename3<>'') AND (Forename2='') THEN
                        BEGIN
                            Forename2:=Forename3;
                            Forename3:='';
                        END;
  ...
  CONTROLS
  {
    ...
    { 1120054034;2;Field  ;
                SourceExpr="Prudential Risk Classification" }
