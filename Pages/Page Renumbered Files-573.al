OBJECT page 172168 Matured FD Card
{
  OBJECT-PROPERTIES
  {
    Date=06/09/23;
    ...
    ActionList=ACTIONS
    {
      ...
      { 1120054011;1 ;Action    ;
                      ...
                      OnAction=BEGIN
                                 ...
                                 GenJournalLine.VALIDATE(GenJournalLine."Currency Code");
                                 GenJournalLine.Amount:="Interest Earned"*0.15;
                                 GenJournalLine.VALIDATE(GenJournalLine.Amount);
                                 GenJournalLine."Shortcut Dimension 1 Code":=DActivity;
                                 GenJournalLine."Shortcut Dimension 2 Code":=DBranch;
                                 GenJournalLine.VALIDATE(GenJournalLine."Shortcut Dimension 1 Code");
                                 ...
                                 GenJournalLine.Description:='Withholding tax on Fixed deposit ';
                                 GenJournalLine.VALIDATE(GenJournalLine."Currency Code");
                                 GenJournalLine.Amount:="Interest Earned"*-1*0.15;
                                 GenJournalLine.VALIDATE(GenJournalLine.Amount);
                                 GenJournalLine."Shortcut Dimension 1 Code":=DActivity;
                                 GenJournalLine."Shortcut Dimension 2 Code":=DBranch;
                                 GenJournalLine.VALIDATE(GenJournalLine."Shortcut Dimension 1 Code");
                                 ...
                                 EntryNo:=1;
                                 END;
                                 AuditTrail.FnInsertAuditRecords(EntryNo,USERID,'Fixed Deposit Amount Transfer',Amount,
                                 'CREDIT',TODAY,TIME,'',"FD No","Account No",'');
  ...
  CODE
  {
    VAR
      ...
      AuditTrail@1120054108 : Codeunit 51516107;
      Trail@1120054107 : Record 51516655;
      EntryNo@1120054106 : Integer;
