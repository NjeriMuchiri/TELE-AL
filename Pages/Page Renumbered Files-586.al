OBJECT page 172181 Loan Application Card(WF)
{
  OBJECT-PROPERTIES
  {
    Date=06/24/22;
                      ...
                      OnAction=VAR
                               ...
                               BEGIN
                                 ...
                                 Msg := 'Dear '+SkyMbanking.FirstName("Client Name")+', your '+"Loan Product Type Name"+ ' application of KSHs.'+FORMAT("Requested Amount")+
                                                           ' has been received and is being worked on. Will be disbursed on '+FORMAT("Application Date")+' at '+FORMAT("Registration Time"+14400000);
                                 END ELSE BEGIN
                                 Msg := 'Dear '+SkyMbanking.FirstName("Client Name")+', your '+"Loan Product Type Name"+ ' application of KSHs.'+FORMAT("Requested Amount")+
