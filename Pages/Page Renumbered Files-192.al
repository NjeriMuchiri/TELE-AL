OBJECT page 17383 Loan Application Card
{
  OBJECT-PROPERTIES
  {
    Date=07/11/23;
  ...
  PROPERTIES
  {
    ...
    OnOpenPage=BEGIN
                 ...
                 IF "Loan Status"="Loan Status"::Rejected THEN
                 CurrPage.EDITABLE:=FALSE;
               END;
    ...
    ActionList=ACTIONS
    {
      ...
      { 1102760045;2 ;Action    ;
                      ...
                      OnAction=BEGIN
                                 ...
                                 AuditTrail.FnInsertAuditRecords(EntryNo,USERID,'Loan Appraisal',"Requested Amount",
                                 'CREDIT',TODAY,TIME,'',"Loan  No.","Client Code",'');
      ...
      { 1000000024;2 ;Action    ;
                      ...
                      OnAction=VAR
                               ...
                               BEGIN
                                 ...
                                 CustomerRecord.CALCFIELDS("Current Shares");
                                 IF "Requested Amount">(CustomerRecord."Current Shares"*3) THEN
                                 ERROR('Requsted amount must not be greater than %1',CustomerRecord."Current Shares"*3);
                                 END;}
                                 ...
                                 TotalGuaranteed:=LoanG."Amont Guaranteed";
                                 END;

                                 LoanCollateralDetails.RESET;
                                 LoanCollateralDetails.SETRANGE(LoanCollateralDetails."Loan No","Loan  No.");
                                 IF LoanCollateralDetails.FINDSET THEN BEGIN
                                   REPEAT
                                     TotalGuaranteed:=TotalGuaranteed+LoanCollateralDetails."Guarantee Value";
                                 ...
                                 THEN ERROR('You Cannot Edit Rejected Loan');
                                 ...
                                 //Charge SMS
                                  LineNo:=LineNo+10000;
                                 GenJournalLine.INIT;
                                 GenJournalLine."Journal Template Name":='PURCHASE';
                                 GenJournalLine."Journal Batch Name":='SMS';
                                 GenJournalLine."Document No.":="Account No";
                                 ...
                                 GenJournalLine.Description:='SMS Charge'+"Loan  No.";
                                 GenJournalLine.VALIDATE(GenJournalLine."Currency Code");
                                 GenJournalLine.Amount:=10;
                                 GenJournalLine.VALIDATE(GenJournalLine.Amount);
                                 GenJournalLine."Bal. Account Type":=GenJournalLine."Bal. Account Type"::"G/L Account";
                                 GenJournalLine."Bal. Account No.":='300-000-055';
                                 ...
                                 GenJournalLine.SETRANGE("Journal Template Name",'PURCHASE');
                                 GenJournalLine.SETRANGE("Journal Batch Name",'SMS');
                                 ...
                                 REPEAT
                                     ...
                                     IF Cust.GET(LoanGuar."Member No") THEN BEGIN
                                        ...
                                        +' with your shares worth '+FORMAT(LoanGuar."Amont Guaranteed")+''
                                           +' '+'Contact '+' +254205029200 '+ ' if in dispute.';
                                         SkyMbanking.SendSms(SMSSource::LOAN_GUARANTORS,Cust."Phone No.",Msg,"Loan  No.",AccountNos,TRUE,0,TRUE);
                                     END;

                                 {
                                   ...
                                   ;}
                                    ...
                                    +' with your shares worth '+FORMAT(LoanGuar."Amont Guaranteed")+''
                                       +' '+'Contact '+' +254727438688 '+ ' if in dispute.';
                                 ...
                                 //SMS MESSAGE/// Loan Approved
                                    ...
                                    //SMS MESSAGE
                                    {
                                     ...
                                     IF Cust.GET("Client Code") THEN BEGIN
                                         ...
                                         Msg := 'Your loan application of KSHs.'+FORMAT("Approved Amount")+
                                                                 ' has been issued. TELEPOST SACCO LTD';


                                         SkyMbanking.SendSms(SMSSource::LOAN_POSTED,Cust."Phone No.",Msg,"Loan  No.","Account No",TRUE,0,TRUE);
                                     END;
      ...
      { 1102755005;2 ;Action    ;
                      ...
                      OnAction=VAR
                                 ...
                                 LoanProducts@1120054000 : Record 51516240;
                               BEGIN
                                 IF "Loan Status"="Loan Status"::Rejected
                                 THEN ERROR('You Cannot Edit Rejected Loan');
                                 SalDetails.RESET;
                                 ...
                                 //SMS MESSAGE
                                     ...
                                     IF Cust.GET("Client Code") THEN BEGIN
                                         ...
                                         Msg := 'Your loan application of KSHs.'+FORMAT("Requested Amount")+
                                                                 ' has been received and will be disbursed in the next . TELEPOST SACCO.';
                                 ...
                                 REPEAT
                                     ...
                                     IF Cust.GET(LoanGuar."Member No") THEN BEGIN
                                         ...
                                         Msg := 'You have guaranteed an amount of '+FORMAT(LoanGuar."Amont Guaranteed")+' to '+"Client Name"+' '+'Loan Type '+"Loan Product Type"+' at TELEPOST SACCO'
                                 ...
                                 AuditTrail.FnGetLastEntry();
                                 AuditTrail.FnGetComputerName();
                                 AuditTrail.FnInsertAuditRecords(EntryNo,USERID,'Loan Sent For Approval',"Requested Amount",
                                 'CREDIT',TODAY,TIME,'',"Loan  No.","Client Code",'');
                                 //End Create Audit Entry
                               END;
                                }
  ...
  CONTROLS
  {
    ...
    { 1102760000;2;Field  ;
                ...
                OnValidate=BEGIN
                             ...
                             // Register.SETFILTER(Register."Loan  No.",'>0');
                             //
                             // //IF Register.FIND('-') THEN BEGIN
                             // //ERROR('This member has pending Loan Application No. %1.',Register."Loan  No.");
                             // //END;
    ...
    { 1120054005;2;Field  ;
                ...
                OnValidate=BEGIN
                             IF "Registration Date">="Application Date"
                               THEN BEGIN
                                 "Registration Date":=CALCDATE("Registration Date"+ 3)
                                 END;
                                 ERROR('The Member Cannot Qualify for a Loan,Registered on 1%.',"Registration Date");
                           END;
                            }
    ...
    { 1120054013;2;Field  ;
                CaptionML=ENU=Interest upfront rate;
                SourceExpr="interest upfront1" }
    ...
    { 1000000039;2;Field  ;
                ...
                OnValidate=BEGIN
                             ...
                             ERROR('You do not have permissions to Edit this Rejected Loan.');
                             END;
    ...
    { 1000000045;2;Field  ;
                SourceExpr="Existing Loan Repayments" }
    ...
    { 1120054001;1;Part   ;
                Name=Loan form;
                CaptionML=ENU=Loan form;
                SubPageLink=Loan=FIELD(DocLink);
                PagePartID=Page51516826;
                PartType=Page }
  ...
  CODE
  {
    VAR
      ...
      "No of Instalments"@1120054000 : Record 51516240;
      "Default Installements"@1120054001 : Record 51516240;
      Active@1120054002 : Option;
      Perfoming@1120054003 : Option;
      LoanProducts@1120054004 : Record 51516240;
      ...
      SkyMbanking@1120054009 : Codeunit 51516701;
      SMSSource@1120054010 : 'NEW_MEMBER,NEW_ACCOUNT,LOAN_ACCOUNT_APPROVAL,DEPOSIT_CONFIRMATION,CASH_WITHDRAWAL_CONFIRM,LOAN_APPLICATION,LOAN_APPRAISAL,LOAN_GUARANTORS,LOAN_REJECTED,LOAN_POSTED,LOAN_DEFAULTED,SALARY_PROCESSING,TELLER_CASH_DEPOSIT,TELLER_CASH_WITHDRAWAL,TELLER_CHEQUE_DEPOSIT,FIXED_DEPOSIT_MATURITY,INTERACCOUNT_TRANSFER,ACCOUNT_STATUS,STATUS_ORDER,EFT_EFFECTED,ATM_APPLICATION_FAILED,ATM_COLLECTION,MBANKING,MEMBER_CHANGES,CASHIER_BELOW_LIMIT,CASHIER_ABOVE_LIMIT,INTERNETBANKING,CRM,MOBILE_PIN,WITHDRAWAL';
      Msg@1120054011 : Text;
      LoanCollateralDetails@1120054012 : Record 51516233;
      AccountNos@1120054013 : Code[40];
    ...
    BEGIN
      ...
      Cust.SETRANGE(Cust."No.","Client Code");
      IF Cust.FIND('-') THEN BEGIN
      SMSMessage."Telephone No":=Cust."Phone No.";//Cust."Phone No.";
      END;
      SMSMessage.INSERT;
    ...
    BEGIN
      ...
      Notification.CreateMessage('Dynamics NAV',GenSetUp."Sender Address",eMAIL,'Loan Receipt Notification',
                      'Loan application '+ LoanApps."Loan  No." +' , ' +LoanApps."Loan Product Type"+' has been received and is under process'
    ...
    LOCAL PROCEDURE DateAdd@1120054000();
    BEGIN
    END;

    LOCAL PROCEDURE "3M"@1120054001();
    BEGIN
    END;
