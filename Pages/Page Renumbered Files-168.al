OBJECT page 17359 Membership Application Card
{
  OBJECT-PROPERTIES
  {
    Date=07/31/23;
  ...
  PROPERTIES
  {
    ...
    OnAfterGetCurrRecord=BEGIN
                           CALCFIELDS(Picture,Signature,"Front Side ID","Back Side ID");
                           UpdateControls();
                         END;
    ...
    ActionList=ACTIONS
    {
      ...
      { 4       ;2   ;Action    ;
                      ...
                      OnAction=VAR
                               ...
                               BEGIN
                                 ...
                                 IF TODAY-"Date of Birth">6479 THEN BEGIN
                                 TESTFIELD("ID No.");
                                 IF NOT (STRLEN("ID No.") >6) AND (STRLEN("ID No.")<8) THEN
                                 ERROR('ID Number should have 7-8 characters.');
                                 END;
                                 ...
                                 END;
                                  ...
                                  IF NOT (STRLEN("ID No.") >6) AND (STRLEN("ID No.")<8) THEN
                                  ERROR('Next of Kin ID Number should have 7-8 characters.');




                                 PhoneNOs:=STRPOS("Phone No.",'+254');


                                 IF PhoneNOs=0 THEN
                                 ERROR('Phone Number should begin with country code +254');


                                 IF STRPOS("Mobile Phone No",'+254')=0 THEN
                                 ERROR('Mobile Phone Number should begin with country code +254');


                                  IF STRLEN("KRA Pin") <>11 THEN
                                  ERROR('KRA Pin  should have 11 characters.');

                                 EmailCheck.CheckValidEmailAddresses("E-Mail (Personal)");
      ...
      { 1       ;2   ;Action    ;
                      ...
                      OnAction=VAR
                                 ...
                                 Sources@1120054001 : 'NEW_MEMBER,NEW_ACCOUNT,LOAN_ACCOUNT_APPROVAL,DEPOSIT_CONFIRMATION,CASH_WITHDRAWAL_CONFIRM,LOAN_APPLICATION,LOAN_APPRAISAL,LOAN_GUARANTORS,LOAN_REJECTED,LOAN_POSTED,LOAN_DEFAULTED,SALARY_PROCESSING,TELLER_CASH_DEPOSIT,TELLER_CASH_WITHDRAWAL,TELLER_CHEQUE_DEPOSIT,FIXED_DEPOSIT_MATURITY,INTERACCOUNT_TRANSFER,ACCOUNT_STATUS,STATUS_ORDER,EFT_EFFECTED,ATM_APPLICATION_FAILED,ATM_COLLECTION,MBANKING,MEMBER_CHANGES,CASHIER_BELOW_LIMIT,CASHIER_ABOVE_LIMIT,INTERNETBANKING,CRM,MOBILE_PIN,WITHDRAWAL';
                               BEGIN
                                 ...
                                 CALCFIELDS(Signature,Picture,"Front Side ID","Back Side ID");
                                 ...
                                 DimensionValue.TESTFIELD(DimensionValue."No. Series");
                                 }
                                 ...
                                 Accounts.Picture:=Picture;
                                 Accounts.Signature:=Signature;
                                 Accounts."Front Side ID":="Front Side ID";
                                 Accounts."Back Side ID":="Back Side ID";
                                 Accounts.INSERT;
                                 ...
                                 IF MembApp."Sms Notification"=TRUE THEN BEGIN
                                 ...
                                 SMSMessage."SMS Message":='Dear '+Name+ ' you have been registered successfully, your Membership No is '
                                 + BOSAACC+'and your FOSA account no is '+AcctNo+'.For further information kindly contact' +CompInfo.Name+' '+GenSetUp."Customer Care No";
                                 SMSMessage."Telephone No":="Phone No.";
                                 IF "Phone No."<>'' THEN
                                 SMSMessage.INSERT;
                                 }
                                 TextMessage:='Dear '+Name+ ' you have been registered successfully, your Membership No is '
                                 + BOSAACC+'and your FOSA account no is '+AcctNo+'.For further information kindly contact' +CompInfo.Name+' '+GenSetUp."Customer Care No";
                                 SMSMessage."Telephone No":="Phone No.";
                                 SkyBanking.SendSms(Sources::NEW_MEMBER,"Phone No.",TextMessage,AcctNo,'',FALSE,205,TRUE);
                                 END;
                                 END;
  ...
  CODE
  {
    VAR
      ...
      SkyBanking@1120054003 : Codeunit 51516701;
      TextMessage@1120054004 : Text[200];
      EmailCheck@1120054005 : Codeunit 400;
      PhoneNOs@1120054006 : Integer;
