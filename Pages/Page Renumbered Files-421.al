OBJECT page 172016 Registry Role Center
{
  OBJECT-PROPERTIES
  {
    Date=06/27/16;
  ...
  PROPERTIES
  {
    ...
    ActionList=ACTIONS
    {
      ...
      { 36      ;1   ;Action    ;
                      ...
                      Image=Report }
      { 1480009 ;1   ;Action    ;
                      CaptionML=[ENU=Loans Potfolio Concentration;
      ...
      { 1000000021;2 ;Action    ;
                      CaptionML=ENU=Membership Application;
                      RunObject=page 17358 }
      { 1000000023;2 ;Action    ;
                      CaptionML=ENU=FOSA Account opening;
      ...
      { 84      ;1   ;ActionGroup;
                      CaptionML=[ENU=Checkoff Processing-Distributed;
      ...
      { 75      ;2   ;Action    ;
                      CaptionML=ENU=Posted Checkoff;
                      RunObject=page 17404 }
      { 1000000002;2 ;Action    ;
                      CaptionML=ENU=Employer Checkoff Remitance;
                      RunObject=page 17401 }
      { 1000000003;2 ;Action    ;
                      CaptionML=ENU=Posted Employer Checkoff;
                      RunObject=page 17404 }
      { 1000000004;2 ;Action    ;
                      CaptionML=ENU=Paybill Processing;
                      RunObject=page 17414 }
      { 1000000005;2 ;Action    ;
                      CaptionML=ENU=Posted Paybill Processing;
                      RunObject=page 17417 }
      { 1000000006;2 ;Action    ;
                      CaptionML=ENU=Interest Due Periods;
                      RunObject=page 17410 }
      { 1000000007;2 ;Action    ;
                      CaptionML=ENU=Checkoff Advice Datasheet;
