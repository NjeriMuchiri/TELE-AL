OBJECT page 50058 Posted Transactions Card
{
  OBJECT-PROPERTIES
  {
    Date=07/28/23;
      ...
      //SMS
          ...
          IF Vend1.FIND('-') THEN BEGIN
            ...
            IF Amount<>0 THEN BEGIN
              SMSMessage."SMS Message":='You have done a Cheque Deposit Transaction of KSHS. '+
              FORMAT(Amount)+' of type '+TransDesc+' on '+FORMAT(TODAY) + ' ' +FORMAT(TIME)+' to your Account at TELEPOST SACCO.';
            END;
      ...
      //SMS
          ...
          IF Vend1.FIND('-') THEN BEGIN
            ...
            IF Amount<>0 THEN BEGIN
              ...
              FORMAT(Amount)+' of type '+TransDesc+' on '+FORMAT(TODAY) + ' ' +FORMAT(TIME)+' from your Account at TELEPOST SACCO';
            END;
            IF Vend1."MPESA Mobile No" <> '' THEN BEGIN
              // SMSMessage."Telephone No":=Vend1."MPESA Mobile No";
            END ELSE BEGIN
      ...
      //SMS
          ...
          IF Vend1.FIND('-') THEN BEGIN
            ...
            SMSMessage."SMS Message":='You have done a transaction of KSHS. '+FORMAT(Amount)+
                                      ' of type '+TransDesc+
                                      ' on '+FORMAT(TODAY) + ' ' +FORMAT(TIME)+' to your Account at TELEPOST SACCO.';
              END ELSE BEGIN

            SMSMessage."SMS Message":='You have done a transaction of KSHS. '+FORMAT(Amount)+
                                      ' of type '+TransDesc+
                                      ' on '+FORMAT(TODAY) + ' ' +FORMAT(TIME)+' from your Account at TELEPOST SACCO.';
