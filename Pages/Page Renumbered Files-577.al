OBJECT page 172172 Fixed Deposit Application
{
  OBJECT-PROPERTIES
  {
    Date=09/08/20;
    ...
    ActionList=ACTIONS
    {
      ...
      { 1120054021;1 ;Action    ;
                      ...
                      OnAction=BEGIN
                                 ...
                                 EntryNo:=1;
                                 END;
                                 AuditTrail.FnInsertAuditRecords(EntryNo,USERID,'Fixed Deposit Termination',Amount,
  ...
  CODE
  {
    VAR
      ...
      FixedR@1120054109 : Record 51516015;
