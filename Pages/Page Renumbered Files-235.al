OBJECT page 17426 Account Applications History
{
  OBJECT-PROPERTIES
  {
    Date=06/20/17;
    ...
    ActionList=ACTIONS
    {
      ...
      { 1102755010;2 ;Action    ;
                      ...
                      OnAction=BEGIN
                                 ...
                                 //AcctNo:=AccoutTypes."Account No Prefix" + '-' + DimensionValue."Account Code" + '-' + DimensionValue."No. Series"
                                 // + '-' + AccoutTypes."Ending Series";
                                 AcctNo:='6864'+DimensionValue."Account Code"+ AccoutTypes."Account No Prefix"+AccoutTypes."Ending Series";
