OBJECT page 172092 Ready ATM Card
{
  OBJECT-PROPERTIES
  {
    Date=02/28/22;
    ...
    ActionList=ACTIONS
    {
      ...
      { 1120054008;2 ;Action    ;
                      ...
                      OnAction=BEGIN
                                 ...
                                 ATMCardApplications.SETRANGE("Account No",Rec."Account No");
                                 ATMCardApplications.SETFILTER("No.",'<>%1',Rec."No.");
                                 IF ATMCardApplications.FINDFIRST THEN BEGIN
                                   REPEAT
                                     ATMCardApplications."Card Status" := ATMCardApplications."Card Status"::Disabled;
                                     ATMCardApplications."Card Status":="Card Status"::Disabled;
                                     ATMCardApplications."Disable On":=TODAY;
                                     ATMCardApplications."Dasabled By":=USERID;
                                     ATMCardApplications.MODIFY;
                                   UNTIL ATMCardApplications.NEXT = 0;
                                 END;
                                 IF Userss.GET(USERID) THEN BEGIN
                                     IF Userss."Link/Delink Atm"=FALSE THEN
                                         ERROR('You Dont Have Rights To Disable ATM.Kindly Contact System Administrator');
                                     ...
                                     TESTFIELD("ATM Card Fee Charged",FALSE);
                                     ...
                                     END
                                     ELSE
                                     MESSAGE('ATM Card Already charged');
                                 END;
                               END;
                                }
      { 1102755008;2 ;Action    ;
                      ...
                      OnAction=BEGIN
                                 ...
                                 IF CONFIRM('Are you sure you want to link ATM CARD: ' +"Card No"+' to the A/C: '+"Account Name",FALSE)=TRUE THEN BEGIN
                                     ...
                                     msg:='Dear '+"Account Name"+', Your Telepost Sacco link Card is ready for collection at the Sacco head office';
                                 ...
                                 //End Create Audit Entry
                                     ...
                                     MESSAGE('ATM Card linked succefully to Account No %1',"Account No");
                                 END
                                 ELSE
                                 MESSAGE('ATM Card already linked to Account No %1',"Account No");
                               END;
                                }
      { 1102755012;2 ;Action    ;
      ...
      { 1120054003;2 ;Action    ;
                      ...
                      RunObject=page 172092;
                      RunPageLink=Account No=CONST(NO);
                      Promoted=Yes;
                      Visible=TRUE;
                      Image=relationship;
                      PromotedCategory=Process;
